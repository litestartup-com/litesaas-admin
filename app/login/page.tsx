...
type LoginWithCodeFormValues = z.infer<typeof loginWithCodeSchema>
...
export default function LoginPage() {
  ...
  } = useForm<LoginWithCodeFormValues>({
  ...
  return (
    <Card className="w-full max-w-md shadow-lg">
      <CardHeader className="space-y-1">
        <CardTitle className="text-2xl font-bold">Welcome to LiteSaaS Admin</CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => setUseVerificationCode(!useVerificationCode)}
              className="text-sm text-primary hover:text-gray-700 font-semibold"
            >
              {useVerificationCode ? "Use password" : "Use verification code"}
            </button>
          </div>

          <Button type="submit" className="w-full" disabled={isLoading}>
            {isLoading ? "Processing..." : useVerificationCode ? "Continue with Email" : "Sign In"}
          </Button>
        </form>
        ...
        <p className="text-xs text-center text-muted-foreground">
          ...
          <Link href="/terms" className="text-black hover:text-gray-700 font-semibold">
            Terms
          </Link>{" "}
          &{" "}
          <Link href="/privacy" className="text-black hover:text-gray-700 font-semibold">
            Privacy Policy
          </Link>
        </p>
      </CardContent>
            ...
            <form onSubmit={handleSubmitReset(onResetPassword)} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  {...registerReset("email")}
                  className={cn(
                    errorsReset.email && "border-destructive focus-visible:ring-destructive"
                  )}
                />
                {errorsReset.email && (
